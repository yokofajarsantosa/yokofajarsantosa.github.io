<body>
    ...
    <section id="sectionKecil">
      <div class="cover" id="cover">
        ...
        <h1>REZA & Lisa</h1>
        <p class="gowunbatang-bold">13 . 12 . 2024</p>
      </div>
      <div class="ayat">
      ...
      <div class="mempelai">
        ...
        <div class="pengantin-pria appear">
          <img
            src="Assets/images/pengantin pria.jpg"
            alt="pengantin pria"
            class="foto"
          />
          <h1>REZA</h1>
          ...
          <a
            href="https://www.instagram.com/akmal.maulana191/"
            target="_blank"
            class="ig"
          >
            <img
        ...
        <div class="pengantin-wanita appear">
          <img
            src="Assets/images/pengantin wanita.jpeg"
          ...
          <a
            href="https://www.instagram.com/savira.alisa61/"
            target="_blank"
            class="ig"
          >
            <img
      ...
      <div class="galeri">
        ...
        <div class="img-container appear">
          <div class="mySlide">
            <img src="Assets/images/Pengantin.jpg" alt="pengantin" />
          </div>
          <div class="mySlide">
            <img src="Assets/images/pengantin pria.jpg" alt="pengantin" />
          </div>
          <div class="mySlide">
            <img src="Assets/images/pengantin wanita.jpeg" alt="pengantin" />
          </div>
